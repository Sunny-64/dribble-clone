...
import { FaTwitter, FaSquareFacebook, FaPinterest, FaInstagram } from "react-icons/fa6";
      ...
      <div className='md:grid md:grid-cols-3 gap-4'>
        <div className='col-span-1 mt-8 px-4'>
          ...
          <div className='flex gap-6 mt-4'>
            ...
            <FaSquareFacebook size={25} className='text-gray-700' />
            <FaPinterest size={25} className='text-gray-700' />
            <FaInstagram size={25} className='text-gray-700' />
          </div>
        </div>
        ...
        <div className='mt-4 col-span-2 grid grid-cols-2 justify-items-stretch sm:grid-cols-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-5'>
          ...
          <div className='flex flex-col gap-3 mt-4'>
            ...
            <a href="#">Careers</a>
            <a href="#">Support</a>
            <a href='#' className='font-bold'>Media kit</a>
          ...
          <div className='flex flex-col gap-3 mt-4'>
            ...
            <a href='#' className='font-bold'>Tags</a>
            <a href="#">Places</a>
          ...
          <div className='flex flex-col gap-3 mt-4'>
            ...
            <a href='#' className='font-bold'>Creative Process</a>
